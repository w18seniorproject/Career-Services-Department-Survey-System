...
CREATE EVENT `Remove Notifications` ON SCHEDULE EVERY 6 MONTH STARTS '2018-06-13 00:00:00.000000' ON COMPLETION PRESERVE ENABLE COMMENT 'Periodically removes notifications from the database' DO UPDATE notifications SET notifications = '';
